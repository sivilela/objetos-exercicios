...
// c) Crie um objeto de `ataque` com a estrutura abaixo e **o 
//adicione no array `ataques`**, utilizando ` **push()**`:
// ```
// nome: "Investida",
// dano: 40,
// tipo: "Normal",
...
//adicione a propriedade **`ataques`** a partir do **espalhamento** da propriedade de
// mesmo nome criada para o objeto original.
copiaPokemon1.ataques = [...pokemon1.ataques] // Dúvida
...
pokemon1.ataques.push({nome: "Folha",
                        dano: 45,
                        tipo: "Grama",
                        precisao: 100                                
})

// f) Para a cópia, crie o `ataque` **“Jato de Água”**, com **40 de dano**, **100 de 
//precisão**, e do tipo **“Água”**; e adicione no array de `ataques`.
...
// g) Imprima ambos os objetos no console e verifique se todas as informações 
//adicionadas aparecem na impressão.
console.log(pokemon1);
console.log(copiaPokemon1);
